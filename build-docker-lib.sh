...
docker build --rm  -f $DIR/docker-lib/Dockerfile -t pontusvisiongdpr/pontus-graphdb-odb-lib:${CURR_TAG} $DIR


docker push pontusvisiongdpr/pontus-graphdb-odb-lib:${CURR_TAG}
