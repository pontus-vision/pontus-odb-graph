...
//      boolean output = getDSARStatsPerRequestType(nowThreshold, oneYearDateThreshold, firstTime, "0-365d", sb);
      ...
      assertTrue(output.contains("{\"dsar_source_type\":\"New (30-365d)\",\"dsar_source_name\":\"TOTAL_STATUS\", \"dsar_count\": 0 },{\"dsar_source_type\":\"Acknowledged (30-365d)\",\"dsar_source_name\":\"TOTAL_STATUS\", \"dsar_count\": 0 },{\"dsar_source_type\":\"Completed (30-365d)\",\"dsar_source_name\":\"TOTAL_STATUS\", \"dsar_count\": 0 }"));
    } catch (Exception e) {
      e.printStackTrace();
      assertNull(e);
    }
