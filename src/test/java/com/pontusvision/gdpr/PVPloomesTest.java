...
//    TODO: parser.city returns a string with no spaces ... Angra dos Reis => angradosreis
      assertEquals("angradosreis", getCityParser, "A cidade de COMIDAS 1 é Angra dos Reis");
...
//    TODO: parser.state for StateId SP returned string with no space or punctuations ... São Paulo => saopaulo
      assertEquals("saopaulo", getStateParser, "O estado de COMIDAS 2 é São Paulo");
...
//              getNullAddress, "Pessoa Nova 3 não tem EDGE Is_Located, porque todos os valores de Location.Address são null");
  ...
  public void test00001PloomesMergedExpanded() throws InterruptedException {
    ...
    try {
      ...
      assertEquals("RUA STA BARBARA, 456, STA BARBARA, PORTO ALEGRE - RS, 90420040",
...
//      assertEquals("jd laranjeiras", getAddressParserSubUrb, "Matheus Rocha's neighborhood");
//    TODO: parser.suburb returned a string with space as the original neighborhood
      ...
      String roadToGloria =
              App.executor.eval("App.g.V().has('Location.Address.parser.road', eq('avenida das almondegas'))" +
