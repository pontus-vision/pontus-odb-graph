...
public class OCompositeKeySerializer implements OBinarySerializer<OCompositeKey> {
  ...
  public static void terminateProcess(OException e, OCompositeKeySerializer thisPtr ) {
  ...
  public OCompositeKey deserializeFromByteBufferObject(
    ...
    for (int i = 0; i < keysSize; i++) {
      ...
      if (binarySerializer == null){
        terminateProcess(new OStorageException("Failed to find binary serializer for "+ serializerId),this);
      }
      final Object key =
