...
//    Status 'Second••Reminder' has 2 white spaces !!
  ...
  public static String[] sensitiveData = getEnv("PV_SENSITIVE_DATA", "DADOS DE SAÚDE,RAÇA,FILIAÇÃO A SINDICATO").split(',')
...
//  today fixed for testing purpuses 1667569252000L = 2022-11-04T13:40:52Z [Friday, 4 November 2022 13:40:52]
    ...
    retentionPeriods.each { retLabel, retVal ->

//    TODO: Test SQL with reversed comparison < and >
//    TODO: diff Person_Natural and Person_Organisation
//    TODO: add if statement to avoid null values
      ...
      for (def result : results) {
        ...
        String rid = result.getProperty('rid')
        ...
        sb.append(" { \"metricname\": \"${PontusJ2ReportingFunctions.translate(retLabel)}\", \"metricvalue\": $rid," +
            " \"metrictype\": \"${PontusJ2ReportingFunctions.translate('Data Retention')}\" }")
